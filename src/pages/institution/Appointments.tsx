...
import { Calendar, MapPin, Package, User, Search, Filter } from 'lucide-react';
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">门店</th>
            ...
            <tr key={apt.id} className="hover:bg-gray-50 transition-colors">
              ...
              <td className="px-5 py-4">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm text-gray-700">{apt.storeName}</div>
                </div>
              </td>
              <td className="px-5 py-4">
              ...
              <td className="px-5 py-4 text-right">
                ...
                {apt.status === 'pending' && (
                  <button className="text-sm text-success-500 hover:text-success-600 font-medium">
                    确认预约
                  </button>
                )}
              </td>
